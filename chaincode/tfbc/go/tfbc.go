...
func (s *SmartContract) getTradeStatus(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {


	return shim.Success(nil)
}

func (s *SmartContract) getLCStatus(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
